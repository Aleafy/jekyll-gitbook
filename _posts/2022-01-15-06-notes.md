...
<img src="../imgs/06/06-02.png" alt="image7" style="zoom: 40%; " />

#### 1.2 亚导数

+ 将导数拓展到不可微的函数，在不可导的点的导数可以用一个范围内的数表示

<img src="../imgs/06/06-03.png" alt="image" style="zoom: 40%;" />
...
<img src="../imgs/06/06-04.png" alt="image" style="zoom:40%;"/>

##### 2.1.2 input是一个向量

<img src="../imgs/06/06-05.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-06.png" alt="image" style="zoom: 40%;" />

##### 2.1.3 input是一个矩阵

<img src="../imgs/06/06-07.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-08.png" alt="image" style="zoom:40%;" />
...
<img src="../imgs/06/06-09.png" alt="image" style="zoom: 40%;" />

##### 2.2.2 input是一个向量

<img src="../imgs/06/06-10.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-11.png" alt="image" style="zoom:40%;" />

##### 2.2.3 input是一个矩阵

<img src="../imgs/06/06-12.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-13.png" alt="image" style="zoom:40%;" />
...
<img src="../imgs/06/06-14.png" alt="image" style="zoom:40%;" />

##### 2.3.2 input是一个向量

<img src="../imgs/06/06-15.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-16.png" alt="image" style="zoom:40%;" />

##### 2.3.3 input是一个向量

<img src="../imgs/06/06-17.png" alt="image" style="zoom:40%;" />

<img src="../imgs/06/06-18.png" alt="image" style="zoom:40%;" />

### 3. 求导的本质

<img src="../imgs/06/06-19.png" alt="image" style="zoom:40%;" />

**可以将f对x1，x2，x3的偏导分别求出来，即**

<img src="../imgs/06/06-20.png" alt="image" style="zoom:40%;" />
...
<img src="../imgs/06/06-21.png" alt="image" style="zoom:40%;" />

（课上是按行向量展开的）

<img src="../imgs/06/06-22.png" alt="image" style="zoom:40%;" />

**X为矩阵时**，先把矩阵变元 ![[公式]](https://www.zhihu.com/equation?tex=%5Cpmb%7BX%7D) 进行**转置**，再对**转置后**的**每个位置**的元素逐个求偏导，结果布局和**转置布局一样**。（课上讲的是这种展开方式）

<img src="../imgs/06/06-23.png" alt="image" style="zoom:40%;" />
...
<img src="../imgs/06/06-24.png" alt="image" style="zoom:40%;" />

##### 4.2 分母布局
2.**分母布局**，就是分母是**列向量**形式，分子是**行向量**形式

<img src="../imgs/06/06-25.png" alt="image" style="zoom:40%;" />
...
<img src="../imgs/06/06-26.png" alt="image" style="zoom: 20%;" />
